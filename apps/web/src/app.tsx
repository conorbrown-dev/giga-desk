  ...
  return (
    <div className="app-shell">
      <aside className="site-sidebar">
        <nav className="site-nav" aria-label="Primary navigation">
          <Link className="brand-link" to="/projects">
            <img
              ...
              src="/images/giga-desk-icon.png"
              alt=""
            />
            <span>
              Giga Desk<small aria-hidden="true">Control center</small>
            </span>
          </Link>
        ...
        <p className="sidebar-footer">Giga Desk · Ops</p>
      </aside>
      <div className="app-content">
        <header className="site-header">
          ...
          <nav className="top-nav" aria-label="Account controls">
            <AccountMenu
            ...
            <Route
              ...
              element={
                <Card className="state-panel">
                  <CardContent>
                    <p>Praxis Project Orchestrator</p>
                    <h1>Turn plans into shipped work.</h1>
      ...
      <main className="auth-page">
        <Card className="auth-card">
          <CardContent className="contents">
            <h1>Giga Desk</h1>
            <Alert variant="destructive">
              <AlertDescription>Auth0 is not configured.</AlertDescription>
            </Alert>
          </CardContent>
        </Card>
      </main>
        ...
        <Card className="auth-card">
          <CardContent className="contents">
            <img
              ...
              src="/images/giga-desk-banner-logo.png"
              alt="Giga Desk"
            />
            <p className="eyebrow">Praxis Project Orchestrator</p>
            <h1>Turn plans into shipped work.</h1>
            <p>
              One command center for projects, agents, and delivery evidence.
            </p>
            <Button
              type="button"
              onClick={() => {
