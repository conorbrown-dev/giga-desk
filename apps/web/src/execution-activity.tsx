...
export function ExecutionActivity({ execution }: { execution: ExecutionHistory }) {
  ...
  return <section className="execution-activity" aria-label="Execution activity">
    <div className="activity-heading"><h3 className="section-label">Activity</h3>{active && <Badge variant="outline" className="live-indicator"><i aria-hidden="true" />Live</Badge>}</div>
