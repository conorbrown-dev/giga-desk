...
export function ProjectWorkItemsPage() {
  ...
  const completedCriteria = workItems?.reduce(
  ...
  return <>
    <header className="page-header work-items-header">
      ...
      <div className="page-header-actions">
        ...
        <CreateFeatureForm projectId={projectId} onCreated={() => {
          setFeatureCreated(true);
          setReload((value) => value + 1);
        }} />
      </div>
    </header>
    {featureCreated && <Alert role="status"><AlertDescription>Feature created.</AlertDescription></Alert>}
