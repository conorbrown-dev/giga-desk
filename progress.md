...
- The fix changes two added-plus-deleted product-code lines. It is packaged locally but not deployed; the installed production worker still uses the prior published bundle until the application is committed, pushed, deployed, and the official installer refreshes the service.
